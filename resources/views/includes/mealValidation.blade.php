...
<script>
    function validateForm(event){
        ...
        let price = document.forms['create_form']['price'].value;
        price = parseFloat(price);
        let image = document.forms['create_form']['image'].value;
        let mealCategory = document.forms['create_form']['meal_category'];
        let array = [];
        ...
        if(image == ""){
            ...
            var scrollDiv = document.getElementById("image").offsetTop;
            window.scrollTo({ top: scrollDiv, behavior: 'smooth'});
            flag = false;
        }else {
