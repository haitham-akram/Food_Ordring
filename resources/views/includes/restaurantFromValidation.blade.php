...
<script>
    function validateForm(){
        ...
        let logo = document.forms['create_form']['logo'].value;
        ...
        if(logo ===""){
            document.getElementById('error_logo').style.display = "inline";
            document.getElementById("logo").focus();
            var scrollDiv = document.getElementById("logo").offsetTop;
            window.scrollTo({ top: scrollDiv, behavior: 'smooth'});
            flag = false;
        }else {
            document.getElementById('error_logo').style.display = "none";
        }
        if(description_en == ""){
